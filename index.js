...
var contactSubmissionSchema = createInsertSchema(contactSubmissions, {
...
async function registerRoutes(app2) {
  app2.post("/api/contact", async (req, res) => {
    try {
      ...
      const [newSubmission] = await db.insert(contactSubmissions).values(validatedData).returning();
      res.status(201).json({
        success: true,
